...
val enumerating : GenericLib.coq_expr list -> GenericLib.coq_expr
...
module TyCtrMap :
  CMap.ExtS
    with type key = GenericLib.Ord_ty_ctr.t
     and module Set := Set.Make(GenericLib.Ord_ty_ctr)

module CtrMap :
  CMap.ExtS
    with type key = GenericLib.Ord_ctr.t
     and module Set := Set.Make(GenericLib.Ord_ctr)
